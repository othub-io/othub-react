...
const queue_txns = async (api_key)=>{
    response = await axios.get(
        `http://localhost:5575/otp/dkg/get?api_key=${api_key}&network=otp::testnet&ual=did:dkg:otp/0x1a061136ed9f5ed69395f18961a0a535ef4b3e5f/356828`
      )
    console.log(`----------GET------------`)
    ...
    response = await axios.get(
        `http://localhost:5575/otp/dkg/create?api_key=${api_key}&network=otp::testnet&txn_data={"color":"green"}&public_address=0x0EFA0c78aA0E5CB851E909614c22C98E68dd882d`
      )
    console.log(`----------MINT------------`)
    console.log(response.data)

    response = await axios.get(
        `http://localhost:5575/otp/dkg/update?api_key=${api_key}&network=otp::testnet&txn_data={"color":"green"}&public_address=0x0EFA0c78aA0E5CB851E909614c22C98E68dd882d&ual=did:dkg:otp/0x1a061136ed9f5ed69395f18961a0a535ef4b3e5f/356828        `
      )
    console.log(`----------UPDATE------------`)
    console.log(response.data)

    response = await axios.get(
        `http://localhost:5575/otp/dkg/transfer?api_key=${api_key}&network=otp::testnet&ual=did:dkg:otp/0x1a061136ed9f5ed69395f18961a0a535ef4b3e5f/356828&receiver=0xaC059720eb0f4568870acb77A3075539FbB962d9&public_address=0x0EFA0c78aA0E5CB851E909614c22C98E68dd882d        `
      )
