                ...
                <tbody>
                  {data.nodeRecords.map((record) => (
                    <tr key={record.nodeId}>
                      ...
                      <td>
                        {record.cumulativePayouts
                          ? record.cumulativePayouts.toFixed(2)
                          : record.cumulativePayouts}
                      </td>
                      <td>
                        {record.cumulativeEstimatedEarnings
                          ? (
                              record.cumulativeEstimatedEarnings -
                              record.cumulativePayouts
                            ).toFixed(2)
                ...
                <tbody>
                  {data.nodeRecords.map((record) => (
                    <tr key={record.nodeId}>
                      ...
                      <td>
                        {record.nodeStake
                          ? record.nodeStake.toFixed(2) + " TRAC"
                          : record.nodeStake + " TRAC"}
                      </td>
                      <td>
                        {record.cumulativePayouts
                          ? record.cumulativePayouts.toFixed(2) + " TRAC"
                          : record.cumulativePayouts + " TRAC"}
                      </td>
                      <td>
                        {record.cumulativeEstimatedEarnings
                          ? (
