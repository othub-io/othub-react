...
const api_key = '6FCVZsJ4djazql4QUlaY3He7W13MvB'
 ...
 const queue_txns = async (api_key) => {
  ...
  //      `http://localhost:5575/dkg/get?api_key=${api_key}&network=otp::testnet&ual=did:dkg:otp/0x1a061136ed9f5ed69395f18961a0a535ef4b3e5f/460455&state=LATEST&txn_description`
  //    )
  //  console.log(`----------GET------------`)
  //  console.log(response.data)

  //  response = await axios.get(
  //      `http://localhost:5575/dkg/getLatestStateIssuer?api_key=${api_key}&network=otp::testnet&ual=did:dkg:otp/0x1a061136ed9f5ed69395f18961a0a535ef4b3e5f/460455`
  //    )
  //  console.log(`----------GET LATEST STATE ISSUER------------`)
  //  console.log(response.data)

  //  response = await axios.get(
  //      `http://localhost:5575/dkg/getOwner?api_key=${api_key}&network=otp::testnet&ual=did:dkg:otp/0x1a061136ed9f5ed69395f18961a0a535ef4b3e5f/460455`
  //    )
  //  console.log(`----------GET OWNER------------`)
  //  console.log(response.data)

  //  response = await axios.get(
  //      `http://localhost:5575/dkg/getStates?api_key=${api_key}&network=otp::testnet&ual=did:dkg:otp/0x1a061136ed9f5ed69395f18961a0a535ef4b3e5f/460455`
  //    )
  //  console.log(`----------GET STATES------------`)
  //  console.log(response.data)

  //  response = await axios.get(
  //      `http://localhost:5575/dkg/getStateIssuer?api_key=${api_key}&network=otp::testnet&ual=did:dkg:otp/0x1a061136ed9f5ed69395f18961a0a535ef4b3e5f/460455&stateIndex=0`
  //    )
  //  console.log(`----------GET STATE ISSUER------------`)
  //  console.log(response.data)

//    response = await axios.post(
//        `http://localhost:5575/dkg/create?api_key=${api_key}&network=otp::mainnet&txn_data={
//           "@type": "Thing",
//            "name" : "color"
...
//    console.log(response.data)
  ...
  //  console.log(response.data)
    ...
    // response = await axios.get(
    //     `http://localhost:5575/dkg/transfer?api_key=${api_key}&network=otp::testnet&ual=did:dkg:otp/0x1a061136ed9f5ed69395f18961a0a535ef4b3e5f/460455&receiver=0x0EFA0c78aA0E5CB851E909614c22C98E68dd882d&public_address=0x0EFA0c78aA0E5CB851E909614c22C98E68dd882d`
    //   )
  ...
  //  console.log(response.data)
    ...
    // response = await axios.get(
    //   `http://localhost:5575/otp_testnet/assetInventory?api_key=${api_key}&owner=0x0EFA0c78aA0E5CB851E909614c22C98E68dd882d`
    // )
    // console.log(`----------INVENTORY------------`)
    // console.log(response.data)

    // response = await axios.get(
    //   `http://localhost:5575/otp_testnet/assetHistory?api_key=${api_key}&ual=did:dkg:otp/0x1a061136ed9f5ed69395f18961a0a535ef4b3e5f/460455`
    // )
    // console.log(`----------HISTORY------------`)
    // console.log(response.data)
  }
